...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in refresh_pb2_grpc.py depends on"
...
class RefreshServiceStub(object):
...
class RefreshServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_RefreshServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    server.add_registered_method_handlers("refresh.RefreshService", rpc_method_handlers)
